        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Accepted Forms</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-9">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Accepted Forms</h3>
            </div>
            ...
            <div class="col-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action='http://localhost/SE-Project/public/pages/admin/pending' >
