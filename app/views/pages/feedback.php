...
class feedback extends View
{
  public function output()
  {
    ...
    $feedback=$_SESSION['user_feedback'];
        ...
        <!-- Feedback card-->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action='http://localhost/SE-Project/public/pages/feedback' >
                    ...
                    <!--username-->
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="inputFeedback" type="feedback" placeholder="$feedback" name="Feedback"require>
                        </div>
